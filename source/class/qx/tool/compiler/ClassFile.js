    ...
    load: function(callback) {
      ...
      fs.readFile(this.getSourcePath(), {encoding: "utf-8"}, function(err, src) {
        ...
        try {
          ...
          t.addMarker("qx.tool.compiler.syntaxError", ex.loc, ex.message, ex.codeFrame);
        ...
        if (!t.__numClassesDefined) {
          t.addMarker("qx.tool.compiler.missingClassDef");
          t.__fatalCompileError = true;
          t._compileDbClassInfo();
          callback();
          return;
        ...
        if (!t.__metaDefinitions[className]) {
          t.addMarker("qx.tool.compiler.wrongClassName", null, className, Object.keys(t.__metaDefinitions).join(", "));
          t._compileDbClassInfo();
        }
      ...
      var CLASS_DEF_VISITOR = {
        Property(path) {
          ...
          if (allowedKeys[keyName] === undefined)
            t.addMarker("qx.tool.compiler.invalidClassDefinitionEntry", prop.value.loc, t.__classMeta.type, keyName);

          if (keyName == "extend") {
            if (!isValidExtendClause(prop)) {
              t.addMarker("qx.tool.compiler.invalidExtendClause", prop.value.loc);
              t.__fatalCompileError = true;
            } else {
