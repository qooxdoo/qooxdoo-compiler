...
describe("Editing and Rewriting JSON", function() {
	...
	getTests('edit', function(testName, data) {
		it(testName, function() {
			...
			var astIn = qx.tool.utils.json.Parser.parseToAst(data["in"]);
			var astPojo = qx.tool.utils.json.Stringify.astToObject(astIn);
			...
			var printed = qx.tool.utils.json.Stringify.reprint(edited, astIn);
