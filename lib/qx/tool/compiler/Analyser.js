...
module.exports = qx.Class.define("qx.tool.compiler.Analyser", {
  ...
  members: {
    ...
    saveDatabase: function() {
      ...
      return qx.tool.compiler.utils.Json.saveJsonAsync(this.getDbFilename(), this.__db)
     ...
     */
    getCldr: function(locale) {
      var t = this;
      var cldr = this.__cldrs[locale];
      if (cldr) {
        return qx.Promise.resolve(cldr); 
      }
     ...
     */
    getTranslation: function(library, locale) {
      var t = this;
      ...
      return qx.Promise.resolve(translation);
    },
