...
qx.Class.define("qx.tool.cli.commands.contrib.Remove", {
  ...
  members: {
    ...
    process: async function() {
      ...
      await this.__deleteRequieredFromManifest(repo_name);
    ...
    __deleteRequieredFromManifest: async function(repoName) {
      ...
      if (manifest.requires && manifest.requires.libraries && manifest.requires.libraries[libraryJson.namespace]) {
          delete manifest.requires.libraries[libraryJson.namespace];
